## Bank Loan For Customers Analysis
...
- 1. Cleaned & Structured Loan Dataset-  Removed nulls / duplicates, Fixed date formats (issue date, last payment date), Created new fields like loan year, issue month, etc.
...
## Dashboard which looks like 
## Power BI Dashboard
![Power BI Dashboard](https://github.com/ChetanaBandurkar/Bank-Loan-For-Customers-Analysis-Project/blob/main/powerbi.png)

## Tableau Dashboard
![Tableau Dashboard](https://github.com/ChetanaBandurkar/Bank-Loan-For-Customers-Analysis-Project/blob/main/tableau.png)
